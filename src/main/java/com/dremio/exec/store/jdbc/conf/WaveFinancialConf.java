...
@SourceType(value = "WaveFinancialARP", label = "WaveFinancial",uiConfig = "wavefinancial-layout.json")
public class WaveFinancialConf extends AbstractArpConf<WaveFinancialConf> {
  private static final String ARP_FILENAME = "arp/implementation/wavefinancial-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.wavefinancial.WaveFinancialDriver";
